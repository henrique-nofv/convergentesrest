...
//
///**
// * Classe especializada em cria tokens Padrão JWT
// * 
...
//	 * 
//	 * Essa é a senha utilizada para realizar a leitura do arquivo de chaves
//	 * privadas.
//	 */
...
//	 * Constantes relacionadas a chave privada.
//	 * 
//	 * Esse é o apelido para a chave privada específica que será utilizada para o
//	 * JWT.
//	 * 
//	 * Quando se cria a chave, um apelido é informado.
//	 */
...
//			/**
//			 * Recupera a chave específica para assinar o JWT
//			 */
...
//
//	/**
//	 * Recupera o PATH do sistema operacional para o arquivo de Key Store onde estão
...
//		/**
//		 * Cria o Cabeçalho do JWT com algorítmo RS256 e define o TOKEN como JWT. Essa é
//		 * a primeira parte do TOKEN.
//		 */
//		JWSHeader jwsHeader = new JWSHeader.Builder(JWSAlgorithm.RS256).type(new JOSEObjectType("jwt")).build();
//		/**
//		 * Cria o objeto de Claims, parte do TOKEN JWT que possui informações de
//		 * Payload. inclunido as Roles Essa é a segunda parte do TOKEN.
//		 */
...
//		/**
//		 * Cria o terceiro bloco que é a assinatura do TOKEN.
//		 */
...
//
//	/**
//	 * Tempo de validade do Token em segundos. 360 é igual a 5 minutos.
//	 */
//	private static final int TOKEN_EXPIRATION_TIME = 360;
//	/**
//	 * Informações que farão parte do TOKEN. As roles representam o papel do
//	 * usuário, como por exemplo, o seu perfil de acesso. a palavra "groups" é
//	 * configurada no standalone.xml para que o wildfly saiba decoficar esse payload
//	 * no retorno do TOKEN e criar as roles do usuário.
//	 */
//	private static final String ROLES = "groups";
//	/**
//	 * Emissor do Token, representa a aplicação que gera o Token.
//	 */
//	private static final String ISSUER = "convergentes-jwt-issuer";
//	/**
//	 * Destinatário do Token, representa o cliente que recebe o Token.
//	 */
//	private static final String AUDIENCE = "convergentes-jwt-audience";
//
//	/**
//	 * Cria a fração chamada de paylod do JWT
//	 * 
//	 * @param subject
//	 * @param rolesBuilder
//	 * @return
...
//		/**
//		 * Cria a lista de papéis, ou perfis de acesso de acordo com a autenticação
//		 * realizada.
//		 */
